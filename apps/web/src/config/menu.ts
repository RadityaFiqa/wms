  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        description: "Kelola template dokumen Word (.docx) dan Document Assembly.",
        href: "/document-templates",
        icon: FileText,
        color: "text-blue-600 bg-blue-50 border-blue-100 dark:bg-blue-955/20 dark:border-blue-900/30",
        btnText: "Kelola Template",
        permissionSubject: "DocumentTemplate",
        permissionAction: "read",
        priority: false,
      },
      {
        name: "Generate Dokumen",
        description: "Buat dokumen baru dari template atau lihat riwayat generate dokumen.",
