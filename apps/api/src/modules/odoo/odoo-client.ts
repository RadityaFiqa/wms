...
export class OdooClient {
   ...
   */
  async getLoginPage(baseUrl: string): Promise<{ csrfToken: string; cookies: string[] }> {
   ...
   */
  async authenticate(baseUrl: string, username: string, pass: string): Promise<{ sessionId: string; csrfToken: string }> {
