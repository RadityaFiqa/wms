...
export declare class GateVerificationController {
    ...
    getAvailableReferences(operationUuid: string, productId?: string, gateItemId?: string, search?: string): Promise<any[]>;
    ...
    confirm(operationUuid: string, req: any): Promise<any>;
